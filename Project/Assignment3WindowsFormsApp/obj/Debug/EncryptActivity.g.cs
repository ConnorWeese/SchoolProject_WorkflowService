...
namespace Assignment3WindowsFormsApp {
    ...
    public partial class EncryptActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(EncryptActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(EncryptActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(EncryptActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".EncryptActivity.g.xaml") || resource.Equals("EncryptActivity.g.xaml"))) {
                    return resource;
                }
            }
