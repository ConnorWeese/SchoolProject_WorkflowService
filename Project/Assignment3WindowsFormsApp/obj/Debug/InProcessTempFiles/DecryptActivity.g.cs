...
namespace Assignment3WindowsFormsApp {
    ...
    public partial class DecryptActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(DecryptActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(DecryptActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(DecryptActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".DecryptActivity.g.xaml") || resource.Equals("DecryptActivity.g.xaml"))) {
                    return resource;
                }
            }
